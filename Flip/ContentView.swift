...
struct ContentView: View {
    @StateObject private var flipManager = FlipManager.shared
    ...
    private var setupView: some View {
            VStack(spacing: 30) {
                ...
                CircularTimePicker(selectedMinutes: $flipManager.selectedMinutes)
                    ...
                    ControlButton(
                        ...
                        content: {
                            Menu {
                                ...
                                HStack {
                                    Text(flipManager.allowedFlips == 0 ? "NONE" : "\(flipManager.allowedFlips)")
    ...
    private var pausedView: some View {
        VStack(spacing: 30) {
            ...
            VStack(spacing: 15) {
                ...
                Text("\(flipManager.pausedRemainingSeconds / 60):\(String(format: "%02d", flipManager.pausedRemainingSeconds % 60)) remaining")
    ...
    private var completionView: some View {
        ...
        private var trackingView: some View {
            VStack(spacing: 30) {
                // Status Icon
                Image(systemName: flipManager.isFaceDown ? "checkmark.circle.fill" : "xmark.circle.fill")
                    .font(.system(size: 60))
