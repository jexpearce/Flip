                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        Image(systemName: "lock.shield.fill").font(.system(size: 40))
                            .foregroundColor(redAccent).padding()
                            .background(
                                Circle().fill(Color.white.opacity(0.1))
                                    .frame(width: 100, height: 100)
                            )

                        Text("Regional Privacy").font(.system(size: 24, weight: .bold))
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        HStack {
                            Text("Visibility Control").font(.system(size: 18, weight: .bold))
                                .foregroundColor(.white)
                    ...
                    if !regionalOptOut {
                        VStack(alignment: .leading, spacing: 16) {
                            Text("How You Appear").font(.system(size: 18, weight: .bold))
                                .foregroundColor(.white)
        ...
        Button(action: action) {
            HStack(spacing: 12) {
                ...
                ZStack {
                    ...
                    if isSelected { Circle().fill(redAccent).frame(width: 16, height: 16) }
                }
