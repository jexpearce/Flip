                        ...
                        Button(action: {
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 12)
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.5), lineWidth: 1.5)
                                    )
                            )
                            .padding(.horizontal, 20)
                        }
                            ...
                            ForEach(buildings, id: \.self) { building in
                                Button(action: {
                                    ...
                                    HStack {
                                        ...
                                        ZStack {
                                            Circle()
                                                .fill(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.2))
                                        ...
                                        VStack(alignment: .leading, spacing: 4) {
                                            ...
                                            HStack(spacing: 4) {
                                                ...
                                                Text(formatDistance(to: building))
                                                    ...
                                                    .foregroundColor(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.9))
                                                    .padding(.horizontal, 8)
                                                    .padding(.vertical, 2)
                                                    .background(
                                                        Capsule()
                                                            .fill(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.1))
                                                            .overlay(
                                                                Capsule()
                                                                    .stroke(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.3), lineWidth: 1)
                                                            )
                                                    )
                                            }
                                        }
                                            ...
                                            Text("\(count) sessions")
                                                ...
                                                .background(
                                                    Capsule()
                                                        ...
                                                        .overlay(
                                                            Capsule()
                                                                .stroke(Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.5), lineWidth: 1)
                                                        )
                                                )
                                                .padding(.trailing, 6)
                                        }
                                    ...
                                    ZStack {
                                        ...
                                        RoundedRectangle(cornerRadius: 12)
                                            .stroke(
                                                LinearGradient(
                                                    colors: [
                                                        Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.4),
                                                        Color(red: 220/255, green: 38/255, blue: 38/255).opacity(0.1)
                                                    ],
                                                    startPoint: .topLeading,
                                                    endPoint: .bottomTrailing
