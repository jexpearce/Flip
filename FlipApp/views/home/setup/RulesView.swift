                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 20) {
                        RuleSection(
                            ...
                            title: "The Flip",
                            content:
                                "After starting a session, you must physically flip your phone face down before the countdown ends. Keep it face down for the entire duration."
                        )
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            Text(
                                "• You'll have 10 seconds to either pause the session or flip back."
                            )
                            .ruleText()
                        ...
                        RuleSection(
                            ...
                            content:
                                "With pauses disabled, any flip will instantly fail your session. For the disciplined only, but will earn you significantly more points. Ensure you are in Do Not Disturb."
                        )
                        ...
                        RuleSection(
                            ...
                            title: "Session End",
                            content:
                                "Your session completes when the timer reaches zero. The phone must remain face down until completion."
                        )
                    }
                    .padding(.horizontal)
                }
