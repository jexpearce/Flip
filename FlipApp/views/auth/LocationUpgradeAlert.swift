    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                // Description
                Text("For best experience, change location to \"Always Allow\" in Settings. This unlocks regional leaderboards, and the Friends Map, and also allows you to flip with the screen off.")
                    .font(.system(size: 16))
