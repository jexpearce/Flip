            ...
            VStack(spacing: 25) {
                ...
                ZStack {
                    ...
                    Image(systemName: "trophy.fill")
                        ...
                        .animation(Animation.easeInOut(duration: 2).repeatForever(autoreverses: true), value: animateGlow)
                }
                .padding(20)
...
extension ScoreManager {
    ...
    func checkForRankPromotion(oldScore: Double, newScore: Double) -> (isPromoted: Bool, newRank: (name: String, color: Color))? {
    ...
    func processSessionWithPromotionCheck(duration: Int, wasSuccessful: Bool, actualDuration: Int, pausesEnabled: Bool) -> (Bool, (String, Color))? {
