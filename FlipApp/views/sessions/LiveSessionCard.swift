        ...
        VStack(spacing: 0) {
            HStack {
                ...
                ZStack(alignment: .topTrailing) {
                    ...
                    if !isFriend {
                        Image(systemName: "person.circle.fill").resizable()
                            .aspectRatio(contentMode: .fit).frame(width: 56, height: 56)
                        ...
                        Image(systemName: "person.fill").resizable().aspectRatio(contentMode: .fit)
                            .frame(width: 56, height: 56).foregroundColor(getProfileColor())
                            .shadow(color: getProfileShadowColor(), radius: 8)
                    }
                    ...
                    Circle().fill(isFull ? Color.gray : getLiveIndicatorColor())
                        ...
                        .shadow(
                            color: getLiveIndicatorColor().opacity(0.6),
                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    HStack(spacing: 6) {
                        Text("LIVE").font(.system(size: 14, weight: .heavy))
                            ...
                            .shadow(
                                color: getLiveTextColor().opacity(0.6),
                                radius: isGlowing ? 4 : 2
                            )
                    ...
                    Text(session.starterUsername).font(.system(size: 20, weight: .bold))
                        .foregroundColor(.white).shadow(color: getUsernameShadowColor(), radius: 6)
                    ...
                    HStack(spacing: 8) {
                        ...
                        Text("Target: \(session.targetDuration)min").font(.system(size: 14))
                ...
                if canJoin {
                    ...
                    Text(isFull ? "FULL" : "UNAVAILABLE").font(.system(size: 14, weight: .bold))
                        .tracking(1).foregroundColor(.gray).padding(.vertical, 8)
            ...
            VStack(spacing: 8) {
                ...
                HStack {
                    ...
                    if session.isPaused {
                        // Show paused status
                        HStack(spacing: 6) {
                            Image(systemName: "pause.circle.fill").foregroundColor(Theme.mutedRed)
