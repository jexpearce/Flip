                            ...
                            .fill(
                                RadialGradient(
                                    gradient: Gradient(colors: [
                                        Color(red: 34/255, green: 197/255, blue: 94/255).opacity(0.25),
                                        Color(red: 34/255, green: 197/255, blue: 94/255).opacity(0.0)
                                    ]),
                                    center: .center,
                                    startRadius: 10,
                                    endRadius: 250
                    ...
                    ZStack {
                        ...
                        Circle()
                            .fill(
                                RadialGradient(
                                    gradient: Gradient(colors: [
                                        Color(red: 56/255, green: 189/255, blue: 248/255).opacity(0.12),
                                        Color(red: 56/255, green: 189/255, blue: 248/255).opacity(0.0)
                                    ]),
                                    center: .center,
                                    startRadius: 5,
                                    endRadius: 150
            ...
            VStack(spacing: 30) {
                ...
                VStack(spacing: 6) {
                    Text("NO SESSIONS YET")
                        ...
                        .tracking(6)
                        .foregroundColor(.white)
                        .shadow(color: Color(red: 34/255, green: 197/255, blue: 94/255).opacity(0.6), radius: 8)
