                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 20) {
                        policySection(
                            ...
                            content: "Flip uses motion tracking and location data to enhance your productivity experience. We do not store motion tracking data, and we never sell your data to third parties. Flip uses Firebase for authentication. Firebase does not sell your data, only processes it to improve app performance. Users can request their data be deleted by emailing jex@jajajeev.com. Requests will be processed within 10 days."
                        )
                        
                        policySection(
                            emoji: "2️⃣",
                            title: "Motion Tracking (Required)",
                            content: "• Tracks motion periodically to ensure your phone remains flipped over during productivity sessions.\n• Optimized for battery efficiency (runs only when needed).\n• Only active during productivity sessions and once upon installation (to request motion permissions)."
                        )
                        ...
                        VStack(alignment: .leading, spacing: 15) {
                            ...
                            Text("Flip is designed with privacy-first principles. You are in complete control of your data, and you can disable location tracking, anonymize your profile, or opt out of leaderboards at any time.")
                                .font(.system(size: 15))
