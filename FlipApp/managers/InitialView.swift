...
struct InitialView: View {
    ...
    enum PermissionType: String, CaseIterable {
        ...
        var description: String {
            switch self {
            case .location: return "Enables regional leaderboards, FlipMaps, and background sessions"
        ...
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                Button(action: {
                    ...
                    // Proceed to main app
                    NotificationCenter.default.post(name: NSNotification.Name("ProceedToMainApp"), object: nil)
                }) {
                    Text("CONTINUE")
                        ...
                        .shadow(color: Color(red: 139/255, green: 92/255, blue: 246/255).opacity(0.4), radius: 8)
                }
    ...
    private func permissionItem(permission: PermissionType, isActive: Bool, isGranted: Bool) -> some View {
        HStack(spacing: 15) {
            // Status indicator
            ZStack {
                Circle()
                    .fill(
                        isGranted ?
                            ...
                            (isActive ? Color(red: 139/255, green: 92/255, blue: 246/255).opacity(0.2) : Color.white.opacity(0.1))
                    )
                ...
                if isGranted {
                    ...
                    Image(systemName: permission.icon)
                        .font(.system(size: 16))
                        .foregroundColor(isActive ? Color(red: 139/255, green: 92/255, blue: 246/255) : .white.opacity(0.7))
                }
            }
            ...
            Image(systemName: isGranted ? "checkmark.circle.fill" : "chevron.right")
                .font(.system(size: 20))
                .foregroundColor(isGranted ? Color(red: 34/255, green: 197/255, blue: 94/255) : .white.opacity(0.4))
                .opacity(isGranted && animateCheckmarks ? 1 : (isGranted ? 0 : 1))
                .animation(.easeIn(duration: 0.5), value: isGranted && animateCheckmarks)
        }
        .padding(.vertical, 12)
            ...
            RoundedRectangle(cornerRadius: 12)
                .stroke(
                    isActive ?
                        LinearGradient(
                            colors: [
                                Color(red: 139/255, green: 92/255, blue: 246/255).opacity(0.7),
