        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    // Description text
                    Text("FLIP lets you compete with others on regional, building, and global leaderboards! Your session counts and focus time will appear on leaderboards with your username.")
                        .font(.system(size: 16))
                    ...
                    VStack(spacing: 15) {
                        featureRow(
                            ...
                            description: "Compete with others in the same building (coffee shops, libraries, etc.)"
                        )
                            ...
                            VStack(spacing: 15) {
                                ...
                                if !regionalOptOut {
                                    VStack(alignment: .leading, spacing: 10) {
                                        ...
                                        Text(regionalDisplayMode == .normal ?
                    ...
                    // Privacy Note
                    Text("You can change these settings anytime in the Regional tab or Profile settings.")
                        .font(.system(size: 13))
                        .foregroundColor(.white.opacity(0.7))
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 20)
